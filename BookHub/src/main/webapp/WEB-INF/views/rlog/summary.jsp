                            ...
                            <c:forEach items="${recentLog}" var="log">
                                <div class="recent-item">
                                    ...
                                    <div class="recent-progress">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar" role="progressbar" style="width: ${percentReadPage}" aria-valuenow="${log.readPage}" aria-valuemin="0" aria-valuemax="${bookInfo[log.bookISBN].get('subInfo').get('itemPage')}"></div>
                                        </div>
